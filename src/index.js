...
export default function Thermometer({width, height, steps, minValue, maxValue, currentValue, showGoalline}) {
    ...
    return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg"  x="0" y="0" width={width} height={height} viewBox="0, 0, 150, 400">
          <defs>

            <clipPath id="cut-off-red">
                <rect x="38"  y={currentValueY} width="600" height="500">
                </rect>
            </clipPath>
            <clipPath id="Clip_1">
            ...
            <radialGradient id="Gradient_1" gradientUnits="userSpaceOnUse" cx="75" cy="343.003" r="37.099">
              ...
              <stop offset="1" stopColor="#EB4A08"/>
            </radialGradient>
          ...
          <g id="Layer_1">
            ...
            <g>
              <path  d="M71,13.375 C78.559,13.506 89.07,19.681 90.588,27.125 L91,27.125 L91,316.532 C103.449,323.042 110.501,335.774 110.841,349.625 C110.841,370.06 94.794,386.625 75,386.625 C55.206,386.625 39.159,370.06 39.159,349.625 C39.135,335.555 46.893,323.321 59,316.532 L59,27.125 L59.412,27.125 C60.793,19.485 67.554,14.751 75,14.375 L71,13.375 z" clipPath="url(#Clip_3)" filter="url(#Shadow_4)" fill="rgba(0,0,0,0.75)"/>
              <path clipPath="url(#cut-off-red)" d="M71,13.375 C78.559,13.506 89.07,19.681 90.588,27.125 L91,27.125 L91,316.532 C103.449,323.042 110.501,335.774 110.841,349.625 C110.841,370.06 94.794,386.625 75,386.625 C55.206,386.625 39.159,370.06 39.159,349.625 C39.135,335.555 46.893,323.321 59,316.532 L59,27.125 L59.412,27.125 C60.793,19.485 67.554,14.751 75,14.375 z" fill="url(#Gradient_1)"/>
            </g>
            {showGoalline && 
            (<text transform="matrix(1, 0, 0, 1, 124.659, 35)">
              <tspan x="-19.341" y="6.5" fontSize="18" fill="#000000">Goal</tspan>
            </text>)}
           
            { /*

             <g>
              <path d="M108.648,45 L108.67,48 L38.67,48.5 L38.648,45.5 L108.648,45 z" clipPath="url(#Clip_5)" filter="url(#Shadow_6)" fill="rgba(0,0,0,0.75)"/>
              <path d="M38.659,47 L108.659,46.5" fill-opacity="0" stroke="#6C5E5E" strokeWidth="3"/>
            </g>
            <g>
              <path d="M4   9.5,66 L49.5,69 L40.5,69 L40.5,66 L49.5,66 z" clipPath="url(#Clip_7)" filter="url(#Shadow_8)" fill="rgba(0,0,0,0.75)"/>
              <path d="M40.5,67.5 L49.5,67.5" fill-opacity="0" stroke="#6A6363" strokeWidth="3"/>
            </g>
              */
            }
          ...
          return <g>
              <text textAnchor="end" x="42" y={eachStep.y - 5} className="small">{eachStep.val}</text>

          <path d={`M49.5, ${eachStep.y} L51, ${eachStep.y} `} filter="url(#Shadow_10)" fill="rgba(0,0,0,0.75)"/>
          <path d= {`M40.5,${eachStep.y} L51, ${eachStep.y}`} fillOpacity="0" stroke="#6A6363" strokeWidth="3"/>
        </g>
          })}
          </g>
        </svg>
