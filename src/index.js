...
export default function Thermometer({width, height, steps, minValue, maxValue, currentValue, showGoalline}) {
    ...
    return (<svg version="1.1" xmlns="http://www.w3.org/2000/svg"  x="0" y="0" width={width} height={height} viewBox="0, 0, 150, 400">
          <defs>

            <clipPath id="cut-off-red">
                <rect x="38"  y="295" width="600" height="500">
                </rect>
            </clipPath>
            <clipPath id="Clip_1">
            ...
            <radialGradient id="Gradient_1" gradientUnits="userSpaceOnUse" cx="75" cy="343.003" r="37.099">
              <stop offset="0" stop-color="#F3F3F3"/>
              <stop offset="1" stop-color="#EB4A08"/>
            </radialGradient>
            <clipPath id="Clip_5">
              <path d="M32.648,37 L114.67,37 L114.67,56.5 L32.648,56.5 z M108.648,45 L38.648,45.5 L38.67,48.5 L108.67,48 L108.648,45 z"/>
            </clipPath>
            <filter id="Shadow_6">
              <feGaussianBlur in="SourceAlpha" stdDeviation="2.5"/>
              <feOffset dx="0" dy="2" result="offsetblur"/>
            ...
            <clipPath id="Clip_7">
              <path d="M34.5,58 L55.5,58 L55.5,77 L34.5,77 z M49.5,66 L40.5,66 L40.5,69 L49.5,69 L49.5,66 z"/>
            </clipPath>
            <filter id="Shadow_8">
              <feGaussianBlur in="SourceAlpha" stdDeviation="2.5"/>
              <feOffset dx="0" dy="2" result="offsetblur"/>
          ...
          <g id="Layer_1">
            <g>
              <path d="M75.548,4.001 L78.104,4.125 L78.192,4.133 C91.512,5.967 100.803,15.73 101.498,28.947 L101.498,29.052 C101.468,29.623 101.452,30.057 101.443,30.417 C101.435,30.835 101.439,30.64 101.432,31 L101.5,31 L101.5,307.594 C115.751,316.615 123.103,332.019 124,348.5 C124,375.286 102.286,397 75.5,397 C48.714,397 27,375.286 27,348.495 C26.989,331.539 35.987,317.262 49.5,307.612 L49.5,31 L49.567,31 C49.561,30.64 49.564,30.835 49.557,30.417 C49.548,30.057 49.531,29.623 49.5,29 C49.5,15.184 61.15,4 75.548,4.001 z M75.5,6 C62.236,6 51.5,16.307 51.499,28.947 C51.53,29.537 51.547,29.989 51.556,30.369 C51.56,30.545 51.565,30.911 51.567,30.952 C51.571,31.083 51.56,31.023 51.723,31.792 L51.98,33 L51.5,33 L51.5,308.658 L51.06,308.955 C36.94,318.493 29.086,332.244 29,348.5 C29,374.181 49.819,395 75.5,395 C101.181,395 122,374.181 122,348.525 C121.584,332.071 113.572,317.514 99.968,308.973 L99.5,308.679 L99.5,33 L99.02,33 L99.277,31.792 C99.44,31.023 99.429,31.083 99.433,30.952 C99.434,30.911 99.439,30.545 99.443,30.369 C99.472,29.497 99.454,29.947 99.498,29.017 C98.607,16.289 90.196,8.294 77.95,6.12 L75.5,6 z" clip-path="url(#Clip_1)" filter="url(#Shadow_2)" fill="rgba(0,0,0,0.75)"/>
              <path  d="M78.056,5.124 C90.746,6.871 99.822,16.113 100.5,29 C100.361,31.64 100.541,30.653 100.255,32 L100.5,32 L100.5,308.126 C114.607,316.983 122.582,331.984 123,348.5 C123,374.734 101.734,396 75.5,396 C49.266,396 28,374.734 28,348.5 C28.09,331.404 36.569,317.536 50.5,308.126 L50.5,32 L50.745,32 C50.459,30.653 50.639,31.64 50.5,29 C50.5,15.745 61.693,5 75.5,5 L78.056,5.124 z" fill-opacity="0" stroke="#6C6E70" stroke-width="2"/>
            </g>
            <g>
              <path  d="M71,13.375 C78.559,13.506 89.07,19.681 90.588,27.125 L91,27.125 L91,316.532 C103.449,323.042 110.501,335.774 110.841,349.625 C110.841,370.06 94.794,386.625 75,386.625 C55.206,386.625 39.159,370.06 39.159,349.625 C39.135,335.555 46.893,323.321 59,316.532 L59,27.125 L59.412,27.125 C60.793,19.485 67.554,14.751 75,14.375 L71,13.375 z" clip-path="url(#Clip_3)" filter="url(#Shadow_4)" fill="rgba(0,0,0,0.75)"/>
              <path clip-path="url(#cut-off-red)" d="M71,13.375 C78.559,13.506 89.07,19.681 90.588,27.125 L91,27.125 L91,316.532 C103.449,323.042 110.501,335.774 110.841,349.625 C110.841,370.06 94.794,386.625 75,386.625 C55.206,386.625 39.159,370.06 39.159,349.625 C39.135,335.555 46.893,323.321 59,316.532 L59,27.125 L59.412,27.125 C60.793,19.485 67.554,14.751 75,14.375 z" fill="url(#Gradient_1)"/>
            </g>
            <text transform="matrix(1, 0, 0, 1, 124.659, 35)">
              <tspan x="-19.341" y="6.5" font-family="HelveticaNeue-Medium" font-size="18" fill="#000000">GGoal</tspan>
            </text>
            <g>
              <path d="M108.648,45 L108.67,48 L38.67,48.5 L38.648,45.5 L108.648,45 z" clip-path="url(#Clip_5)" filter="url(#Shadow_6)" fill="rgba(0,0,0,0.75)"/>
              <path d="M38.659,47 L108.659,46.5" fill-opacity="0" stroke="#6C5E5E" stroke-width="3"/>
            </g>
            <g>
              <path d="M49.5,66 L49.5,69 L40.5,69 L40.5,66 L49.5,66 z" clip-path="url(#Clip_7)" filter="url(#Shadow_8)" fill="rgba(0,0,0,0.75)"/>
              <path d="M40.5,67.5 L49.5,67.5" fill-opacity="0" stroke="#6A6363" stroke-width="3"/>
            </g>
            <g>
              <path d="M49.5,199 L49.5,202 L40.5,202 L40.5,199 L49.5,199 z" clip-path="url(#Clip_9)" filter="url(#Shadow_10)" fill="rgba(0,0,0,0.75)"/>
              <path d="M40.5,200.5 L49.5,200.5" fill-opacity="0" stroke="#6A6363" stroke-width="3"/>
            </g>
